...
| AC10 | All | Attractive README and complete, accurate user/operator guides | C3 VERIFIED-WITH-LIMITATIONS; preservation approved | README/main-feature navigation and canonical guides independently checked and reviewed: 15 repository documents, 12 browser views/three navigation actions, 20 installed-layout links. Local rendering, not github.com or actual host installation. |
